        ...
        <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea className="h-36 resize-none" {...field} value={field.value || ""} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
          ...
          <div>
            ...
            <div className="flex gap-4 ">
              <NCImageUploader setImageFiles={setImageFiles} setImagePreview={setImagePreview} label="Upload Image" className="w-fit mt-0" />
              <ImagePreviewer
          ...
          <div>
            <div className="flex justify-between items-center border-t border-b py-3 my-5">
              ...
              <Button variant="outline" className="size-10" onClick={addColor} type="button">
